...
import { SupportText } from '../../FormFields/SupportText';
    ...
    >
      ...
      {req && (
        <div className="mb-4">
          ...
          <SupportText intent="help" className="-mt-6">
            {reqNote}
          </SupportText>
        </div>
      )}
      ...
      {action && <div className="mt-4 pt-4 flex justify-center items-start">{action}</div>}
