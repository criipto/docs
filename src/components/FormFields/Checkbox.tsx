        ...
        <label className={cx('contents', disabled ? 'cursor-not-allowed' : 'cursor-pointer')}>
          ...
          <div
            className={cx(
              ...
              'peer-checked:after:h-2.5 peer-checked:after:w-2.5',
              'peer-checked:after:bg-checkMark peer-checked:after:bg-no-repeat peer-checked:after:bg-center peer-checked:after:bg-contain',

              // Indeterminate: dash
              'peer-indeterminate:after:opacity-100',
              'peer-indeterminate:after:h-2.5 peer-indeterminate:after:w-2.5',
              'peer-indeterminate:after:bg-dash peer-indeterminate:after:bg-no-repeat peer-indeterminate:after:bg-center peer-indeterminate:after:bg-contain',
            )}
            aria-hidden="true"
          />
