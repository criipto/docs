...
- Before you can order the client credentials from Vipps, you will need to have created a production domain in Idura Verify as described in the [Getting ready for production guide](/verify/guides/production).
  Once you have set up the production domain, go to the [Vipps MobilePay](https://dashboard.idura.app/providers/NO_VIPPS) eID provider screen and take note of the URL displayed. It must be supplied during merchant registration.

![Vipps MobilePay setup](./images/vipps-mobilepay.png)

### Signing a merchant agreement

You can register as a merchant by signing an agreement with Vipps MobilePay.
Use the links below to start registration via Idura’s partner setup.

- [Vipps MobilePay Login for Customer Service](https://portal.vipps.no/register/template/6584acdd-1b8d-407d-a4f6-ff03a3a2df43):
  Use this option if you want to authenticate callers when they contact your customer service.

- [Vipps MobilePay Login for Online Web](https://portal.vipps.no/register/template/d5e49915-4b07-478b-b7f3-653e460eb6f6):
  Use this option if you want to use Vipps MobilePay Login on your webpages to pre-fill user information.
