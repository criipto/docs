...
The goal of Idura Signatures is to be fully customizable to fit exactly into your workflow.
...
```text
{
  "input": {
    "ui": {
      "logo": {
        "src": "https://www.idura.eu/hubfs/logo.svg", // required
        "href": "https://www.idura.eu" // can be left null
      }
    }
  }
}
