...
```text
https://YOUR_SUBDOMAIN.criipto.id/oauth2/authorize?scope=openid ssn&...
```
Alternatively, you can send them in the `login_hint`
```text
https://YOUR_SUBDOMAIN.criipto.id/oauth2/authorize?...&login_hint=scope:ssn&...
```
...
<p style={{textIndent: "50px"}}><a href="mailto:orders@criipto.com?subject=NO BankID for ...">orders@criipto.com</a></p>
