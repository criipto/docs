...
First, create a new [application](/verify/getting-started/basics/#applications) for your Okta tenant in Idura Verify. This is done via the [Idura Dashboard](https://dashboard.idura.app/applications/add?tags=authentications).
