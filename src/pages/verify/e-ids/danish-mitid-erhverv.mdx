...
If you do require CPR numbers, you can collect them by enabling the two toggles in the [management dashboard](https://dashboard.idura.app/providers/DK_MITID):
...
<video controls>
  <source
    src="https://www.criipto.com/hubfs/MitID%20Erhverv%20Test%20Users%20Video/test_user_mitid_erhverv.mp4"
    type="video/mp4"
  />
</video>
