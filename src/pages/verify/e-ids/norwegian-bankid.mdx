...
5. Open the following page and enter the birth number for the test number in the NNIN field to get your your SMS one-time code: https://toba-preprod.bankidapis.no/test/events
...
7. Check the **Accept terms** box and press the **Approve** button
8. Press the **Activation codes** button
10. Press the **Send code words** button in the "Is this your email?” screen
11. Open the following page and enter the birth number for the test number in the NNIN field to get your your email code words: https://toba-preprod.bankidapis.no/test/events
...
15. Type "qwer1234” as personal password and click the *Next* button
...
18. Run your first biometrics-based login to sign the biometrics terms
...
You can use the [Idura Dashboard](https://dashboard.idura.app/providers/NO_BANKID) to configure access to the optional user data, in the **Identity Sources** -> **NO BankID** section.
...
Once you have received credentials, they must be entered into the Idura dashboard to configure your NO BankID integration. This is done under <a href="https://dashboard.idura.app/providers/NO_BANKID" target="_blank">eID providers > NO BankID</a>.
