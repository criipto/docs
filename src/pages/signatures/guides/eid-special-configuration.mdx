...
To retrieve name information from iDIN, you will need to provide an additional scope on either signature order or sigantory level to enable [full identification](/verify/e-ids/dutch-idin/#full-identification).
