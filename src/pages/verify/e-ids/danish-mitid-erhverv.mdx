...
A company signatory is also sometimes referred to as a _management representative_ (DK: _ledelsesrepræsentant_), or as someone who _is authorized to represent_ the company.
...
If you don't need _company signatories_, you can **Disable signatories for MitID business logins** in your Idura Dashboard in **eID providers** > **Danish MitID**.
...
Idura relies on the user's UUID to retrieve this information from the MitID Erhverv API.
...
If you do require CPR numbers, you can collect them by enabling the two toggles on the [Danish MitID](https://dashboard.idura.app/providers/DK_MITID) eID provider screen on the Idura Dashboard:
...
This will allow _company signatories_ and _employees_ to log in to your site or application with their personal MitID or their dedicated employee MitID (depending on how they have been setup in MitID Ervherv).
...
- <a href="https://pp.mitid.dk/test-tool/frontend/#/create-identity" target="_blank">
    MitID Test Tool
  </a>
- <a href="https://mitidsimulator.test-devtest4-nemlog-in.dk/Home/Create" target="_blank">
    MitID Simulator
  </a>

_Test users CAN HAVE the same user ID._
_Test users MUST HAVE a CPR number, and it MUST BE the same in the 2 test-user creation tools listed above._
...
<video controls>
  <source
    src="https://www.idura.eu/hubfs/MitID%20Erhverv%20Test%20Users%20Video/test_user_mitid_erhverv.mp4"
    type="video/mp4"
  />
</video>
