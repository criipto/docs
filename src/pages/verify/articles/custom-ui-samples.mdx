...
<div class="content-wrapper">
  ...
  <div class="sidebox">
    ...
    <p>We use eIDs to confirm your identity and prevent any unauthorized sign-ins in your name.</p>
  ...
  <div class="infobox">
    <div class="infobox-content">
      ...
      <div class="infobox-text">
        <h1 class="sidebox-heading">Hey! <span>Log in</span> to your Cool Energy profile</h1>
        <p>
          Don't have BankID? <br />
          Log in using a one-time code sent to your email or your confirmed mobile number.<br /><br />
          Don't have a Cool Energy profile? Open one now by contacting your agent or logging in with
          BankID.
        </p>
      </div>
      <div class="infobox-footer">
        <p>
          coolenergy.dk ·
          <a href="#">Cookie Policy and Handling of Personal Data</a>
        </p>
