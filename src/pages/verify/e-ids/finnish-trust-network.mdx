...
A legal agreement with Idura is mandatory to access FTN. You can request one by filling out the <a href="https://dashboard.idura.app/providers/FI_TELIA/contract" target="_blank"> FTN Production Agreement form </a> in your Idura Dashboard.
