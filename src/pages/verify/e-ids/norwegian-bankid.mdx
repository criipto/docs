...
4. Open the following page and enter the birth number for the test number in the NNIN field to get your your SMS one-time code: https://toba-preprod.bankidapis.no/test/events
...
The table below provides a list of options for using `login_hint` with Norwegian BankID, and the resulting user flows. Check [our guide on prefilled fields](/verify/guides/prefilled-fields/) to learn more.
...
4. Authorized signatory(ies) listed in the business registry who are authorized to sign for the company: _Name, mobile phone and email_.
...
9. Your **Idura production domain** as set up in step 4 of the [Getting ready for production](/verify/guides/production) guide.
