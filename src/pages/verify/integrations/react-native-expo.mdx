...
Before you can start sending authentication requests to Idura Verify, you need to register the URLs on which you want to receive the returned _JSON Web Token_, [JWT](verify/getting-started/token-contents/).
