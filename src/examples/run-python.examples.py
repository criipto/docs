...
CRIIPTO_SIGNATURES_CLIENT_ID = os.getenv("CRIIPTO_SIGNATURES_CLIENT_ID") or err(
  "CRIIPTO_SIGNATURES_CLIENT_ID is missing"
)
CRIIPTO_SIGNATURES_CLIENT_SECRET = os.getenv("CRIIPTO_SIGNATURES_CLIENT_SECRET") or err(
  "CRIIPTO_SIGNATURES_CLIENT_SECRET is missing"
)

exitCode = 0
for file in (
  glob("./**/*.py", root_dir=dir_path) if args.filename is None else [args.filename]
):
