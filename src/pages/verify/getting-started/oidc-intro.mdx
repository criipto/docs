...
The Headless flow is a custom protocol by Idura. It allows interacting with eIDs that offer a poll-based workflow, where user agent redirect is not required.
...
Please note that you don’t need to perform the steps below manually. Most often they are handled by configuring an OpenID Connect package on your platform of choice.
