...
You must enable the "Add CPR for MitID logins" toggle in the [management dashboard](https://dashboard.idura.app/providers/DK_MITID).
...
1. Send an email to <a href="mailto:support@idura.eu">support@idura.eu</a> with your desired domain prefix.
