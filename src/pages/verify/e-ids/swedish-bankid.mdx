...
Text signing has a different eID cost than authentication. If you have questions, please [contact sales](https://www.idura.eu/contact).
...
To order the actual certificate, simply <a href={template} download>download this form</a> and return a filled-out copy to <a href="mailto:orders@idura.eu?subject=Swedish BankID for ...&body=Tenant link:" >orders@idura.eu</a> along with your <a href="https://dashboard.idura.app/support/" target="_blank">tenant support link</a>.
