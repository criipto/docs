...
If your company is *not* registered in Denmark, meaning you don't have MitID Erhverv, please send a request for MitID onboarding to [orders@criipto.com](mailto:orders@criipto.com).
