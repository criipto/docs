...
Idura Verify is an OpenID Provider. It is integrated through the authentication API which follows the <a href='https://openid.net/specs/openid-connect-core-1_0.html' target="_blank">OpenID Connect</a> and <a href='https://datatracker.ietf.org/doc/html/rfc6749' target="_blank">OAuth 2.0</a> specifications.
