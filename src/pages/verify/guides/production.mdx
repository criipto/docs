...
1. If you haven't done so already, go to [dashboard.idura.app](https://dashboard.idura.app/billing), select the **Billing** tab, and choose a plan that suits your expected usage.
