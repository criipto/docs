...
sort: 2
title: Rate limiting
subtitle: SSO rate limiting overview.
---

Idura Verify applies rate limits on two different levels:
...
We don’t disclose the specifics of our DoS and DDoS protection, but you'll find the limits that apply to [Single Sign-on requests](/verify/reference/glossary/#single-sign-on-sso) below.

## Single sign-on (SSO) limits

Idura Verify has two per-user rate limits for how many SSO attempts can be performed.
