...
To order the actual certificate simply <a href={template} download>download this form</a> and return a filled out copy to <a href="mailto:orders@criipto.com?subject=Swedish BankID for ...">orders@criipto.com</a>
